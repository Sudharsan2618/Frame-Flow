      ...
      <div className="mx-auto grid min-h-screen max-w-6xl items-center gap-8 px-4 py-8 sm:gap-12 sm:px-6 sm:py-12 lg:grid-cols-2">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-pretty text-muted-foreground">
            Join thousands of learners. Access courses, track your progress, and get matched with job opportunities.
          </p>
          <div className="grid gap-3 text-sm text-muted-foreground">
            {[
              "Access free and premium courses with video, quizzes & flashcards",
          ...
          <Button variant="outline" asChild className="w-fit bg-transparent">
            <Link href="/student/login">
              Already have an account? Sign In <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
        </div>
